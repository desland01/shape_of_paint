...
**Source:** `.gemini/commands/hormozi-sanchez-writer.md`
...
**Source:** `.gemini/commands/kyle-roof-seo.md`, `.gemini/commands/on-page-seo.md`
...
**Source:** `.gemini/skills/sterling-sky-local-seo/SKILL.md`, `.gemini/commands/local-seo.md`
...
**Source:** `.gemini/commands/reverse-silo.md`
...
|-----------|----------------|
| Deep copywriting | `.gemini/commands/hormozi-sanchez-writer.md` |
| SEO analysis | `.gemini/commands/kyle-roof-seo.md` |
| Page optimization | `.gemini/commands/on-page-seo.md` |
| Content silo planning | `.gemini/commands/reverse-silo.md` |
| GBP optimization | `.gemini/skills/sterling-sky-local-seo/SKILL.md` |
| Local ranking strategy | `.gemini/commands/local-seo.md` |
| Landing pages (paid traffic) | `.gemini/skills/landing-pages/SKILL.md` |
