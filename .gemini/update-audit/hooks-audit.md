...
### SessionEnd (command)
- **Status: INFO**
- Handler: `bash ~/.gemini/scripts/cleanup-orphaned-watchers.sh`
- File exists: YES (`/Users/thebeast/.gemini/scripts/cleanup-orphaned-watchers.sh`)
- Issues:
...
- **Status: INFO**
- Handler: `node "/Users/thebeast/.gemini/hooks/gsd-check-update.js"`
- File exists: YES
- Issues:
...
- **Status: OK**
- Commands:
  - `node "/Users/thebeast/.gemini/hooks/gemini-code-update-checker.js"` — file exists: YES, timeout: 10000 ms (explicit — good)
...
- **Status: INFO**
- Handler: `~/.gemini/skills/context-guardian/scripts/enforce-single-skill.sh`
- File exists: YES (resolved to `/Users/thebeast/.gemini/skills/context-guardian/scripts/enforce-single-skill.sh`)
- Issues:
...
- **Status: OK**
- Handler: `/Users/thebeast/.gemini/hooks/auto-load-anthropic-ref.sh`
- File exists: YES
...
### `statusLine` key
- **Status: OK**
- `statusLine` is a known valid top-level key. The referenced file `/Users/thebeast/.gemini/hooks/gsd-statusline.js` exists on disk. No issues.
...
- **SessionStart [handler 2]**: Runs `gemini-code-update-checker.js` with explicit 10 000 ms timeout, then injects a changelog review prompt.
