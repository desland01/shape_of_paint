...
- **Aesthetic:** Artisan/Premium (Warm neutrals, watercolor motifs, soft shadows, serif headings). Avoid industrial/machined looks.
...
| "I want to..." | Do this |
|-----------------|---------|
| Build a new interactive element (form, calculator, wizard) | Read `.gemini/skills/interactive-elements/SKILL.md` or run `/interactive-elements` |
| Add bottom sheet input to a form field | Read `.gemini/skills/interactive-elements/mobile-input-reference.md` |
| Add steps to a step wizard | Read `.gemini/skills/interactive-elements/step-wizard-reference.md` |
| Build or modify calculator logic | Read `.gemini/skills/interactive-elements/calculator-reference.md` |
...
**Read `.gemini/requirements.md` before any content or SEO task.** It summarizes the rules below.
...
Per Kyle Roof methodology in `.gemini/commands/kyle-roof-seo.md`:
...
Per `.gemini/commands/hormozi-sanchez-writer.md`:
...
| `.gemini/requirements.md` | Copywriting and SEO standards |
