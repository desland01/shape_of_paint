...
**Source:** `.codex/commands/hormozi-sanchez-writer.md`, `.codex/commands/premium-writer.md`
...
**Source:** `.codex/commands/kyle-roof-seo.md`, `.codex/commands/on-page-seo.md`
...
**Source:** `.codex/skills/sterling-sky-local-seo/SKILL.md`, `.codex/commands/local-seo.md`
...
**Source:** `.codex/commands/reverse-silo.md`
...
|-----------|----------------|
| Deep copywriting | `.codex/commands/hormozi-sanchez-writer.md`, `.codex/commands/premium-writer.md` |
| SEO analysis | `.codex/commands/kyle-roof-seo.md` |
| Page optimization | `.codex/commands/on-page-seo.md` |
| Content silo planning | `.codex/commands/reverse-silo.md` |
| GBP optimization | `.codex/skills/sterling-sky-local-seo/SKILL.md` |
| Local ranking strategy | `.codex/commands/local-seo.md` |
| Landing pages (paid traffic) | `.codex/skills/landing-pages/SKILL.md` |
