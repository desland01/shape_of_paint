...
export const metadata: Metadata = {
  title: "Paint Guides & Expert Tips | Shape of Paint",
  description:
    "Expert painting guides, cost breakdowns, and colour advice from Vancouver house painters. Interior, exterior, and cabinet painting insights for homeowners.",
};
