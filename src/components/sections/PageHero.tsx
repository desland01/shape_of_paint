...
export function PageHero({
  ...
  return (
    <section
      className={
        hasImage
          ? "relative flex min-h-[55vh] items-center justify-center text-center py-24 md:py-32"
